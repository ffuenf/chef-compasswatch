...
attribute :css_path, kind_of: String
attribute :http_stylesheets_path, kind_of: String
attribute :sass_dir, kind_of: String, default: 'sass'
attribute :sass_path, kind_of: String
attribute :images_dir, kind_of: String, default: 'images'
attribute :images_path, kind_of: String
attribute :http_images_path, kind_of: String
attribute :generated_images_dir, kind_of: String
attribute :generated_images_path, kind_of: String
attribute :http_generated_images_path, kind_of: String
attribute :javascripts_dir, kind_of: String
attribute :javascripts_path, kind_of: String
attribute :http_javascripts_path, kind_of: String
...
attribute :additional_import_paths, kind_of: String
attribute :disable_warnings, kind_of: [TrueClass, FalseClass], default: false
attribute :sass_options, kind_of: String
...
attribute :fonts_dir, kind_of: String
attribute :fonts_path, kind_of: String
attribute :http_fonts_path, kind_of: String
attribute :http_fonts_dir, kind_of: String
